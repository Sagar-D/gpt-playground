...
email_list = [
    ...
    "Hi BuyBuy, I just wanted to let you know how much I’ve been enjoying the air fryer I purchased from your downtown Dallas store. It has completely changed the way I cook meals for my family. It’s so easy to use, and the results are fantastic every single time. I’ve been able to make healthier versions of our favorite fried foods, and cleanup is a breeze. I’ll definitely be recommending this to everyone I know. Thank you for such a great product! Best wishes, Sophia",
    "Dear BuyBuy, I am reaching out because I am very unhappy with the recliner chair I recently purchased. It looked great in the store (in Oakland), but within two weeks of using it, the reclining mechanism completely stopped working. I have been in touch with customer support, but the process of getting a replacement has been painfully slow and frustrating. This whole situation has left me very disappointed in your brand. I hope you can improve your quality control and customer service. Sincerely, Noah",
    "Hello BuyBuy, I just wanted to say how much I love the new headphones I bought from your store. The sound quality is incredible, with crystal-clear highs and deep bass that really makes my music come alive. They’re also extremely comfortable, even when I wear them for hours at a time while working. I feel like I got great value for my money, and I’ll definitely be shopping with you again in the future. Keep up the fantastic work! Warm regards, Olivia",
    "To BuyBuy, I regret to inform you that I am very dissatisfied with the bed frame I purchased from your New York store. After just one week of use, it started creaking loudly with even the slightest movement, making it difficult to get a good night’s sleep. I expected much better quality for the price I paid, and I feel very let down by this purchase. I hope you take this feedback seriously and address these quality issues in the future. Regards, Ethan",
]

system_message = """\
You are an AI assistant who goes through the list of emails written by customers \
and provide back helpful insights as instructed by the user.\
"""
...
prompt_template = ChatPromptTemplate.from_messages(
    [
        ...
        (
            "human",
            """Below are the emails written by the customers :
{emails}

Go through these emails and figure out :
1. Which category of product has most negative sentiment by customers
2. Which store has most customer complaints 

Just respond with above data. Don't add any extra details, comments or notes.
""",
        ),
    ]
)
...
for email in email_list:
    index += 1
    formatted_email_string += f"{index}. {email}\n"

response = chain.invoke({"emails": email_list})
print(response)
