...
MEETING_MOM_PROMPT = PromptTemplate.from_template(
    """You are a helpful assistant whose job is to understand the meeting transcripts and create meeting summary and Minutes of Meeting (MoM).
...
4. If there isn't enough data to populate any section of MoM, skip that section.
5. Based on semantic understanding, populate pointers for sections like Key decisions made, Action Items etc
